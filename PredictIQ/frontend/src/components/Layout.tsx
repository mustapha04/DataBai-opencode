...
import { Moon, Sun, Database, BarChart3, Brain, PieChart, LogOut, User, TrendingUp, Shield, Upload, MessageSquare } from 'lucide-react';
        ...
        {user && !isAuthPage && (
          <div style={{
            ...
            <button className="btn btn-sm" onClick={() => navigate('/upload')}
              style={isActive('/upload') ? { background: 'var(--accent)', color: '#0a0e1a', borderColor: 'var(--accent)' } : {}}>
            ...
            <button className="btn btn-sm" onClick={() => navTo('analytics')}
              style={isActive('/analytics') ? { background: 'var(--accent)', color: '#0a0e1a', borderColor: 'var(--accent)' } : {}}>
            ...
            <button className="btn btn-sm" onClick={() => navTo('chat')}
              style={isActive('/chat') ? { background: 'var(--accent)', color: '#0a0e1a', borderColor: 'var(--accent)' } : {}}>
